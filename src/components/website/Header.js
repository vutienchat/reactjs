  ...
  return (
    <>
      ...
      <header
        className={
          fixedHeader
            ? "sticky w-full top-0 z-10 bg-gray transition delay-300 duration-500"
            : "sticky w-full transform -translate-y-full top-0 z-10 bg-gray transition delay-300 duration-500"
        }
      >
        <div className="flex items-center px-0 md:px-10 py-9">
          ...
          <MainMenu />
          <div className="header-right-icon flex ml-auto">
            <span className="px-2">
              <svg
