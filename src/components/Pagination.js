        ...
        <button
          ...
          className={
            _page === i + 1
              ...
              : "relative focus:outline-none block py-1.5 px-2.5 leading-tight bg-transparent border border-[#cebaa4] text-[#cebaa4] border-r-0 hover:main-bg hover:text-white cursor-pointer"
          }
  ...
  return (
    pageCount > 1 && (
      <div className="flex pl-0 list-none rounded my-2">
        ...
        <button
          disabled={_page >= pageCount}
          className="disabled:opacity-50 relative focus:outline-none block py-1.5 px-2.5 leading-tight bg-transparent border border-[#cebaa4] text-[#cebaa4] rounded-r hover:main-bg hover:text-white"
          onClick={() => handlePageClick(_page + 1)}
        >
          Next
        </button>
