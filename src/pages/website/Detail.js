      ...
      <section className="overflow-hidden">
        <div className="container pt-20 pb-10 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <div className="lg:w-2/5 w-full rounded border border-[#cebaa4] overflow-hidden hover:cursor-[crosshair]">
              {productDetail ? (
                <ReactImageZoom {...imageZoom} />
              ) : (
                <div className="bg-gray-200 h-full animate-pulse"></div>
              )}
            </div>
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              {productDetail ? (
                ...
                <div className="flex flex-1 flex-col gap-3">
                  <div className="bg-gray-200 w-4/5 animate-pulse h-14 rounded-2xl" />
