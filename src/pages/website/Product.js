      ...
      <div className="container">
        <div className="flex items-center justify-between py-5">
          ...
          <div className="text-white">
            <span>
              <Link className="main-text hover:main-text" to="/">
                Home
              </Link>
            </span>{" "}
            / <span className="main-text-active">Products</span>
          </div>
        </div>
        <div className="flex justify-between items-center py-5 border-b border-yellow">
          <div className="flex">
            ...
            <select
              className="bg-transparent text-white focus:outline-none text-sm px-5"
              onChange={sortSelect}
            >
              <option className="text-gray-500 text-sm" value=" ">
                --- Tất cả ---
              </option>
              <option className="text-gray-500 text-sm" value="price_lte=300">
                Giá dưới 300
              </option>
              <option
                className="text-gray-500 text-sm"
                value="price_gte=300&price_lte=600"
              >
                Giá 300 -&gt; 600
              </option>
              <option className="text-gray-500 text-sm" value="price_gte=600">
                Giá trên 600
              </option>
              <option
                className="text-gray-500 text-sm"
                value="_sort=new_price&_order=-1"
              >
                Giá giảm dần
              </option>
              <option
          ...
          <div className="text-gray-500 text-sm">
            We found{" "}
            <span className="main-text-active">
