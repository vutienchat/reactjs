                    ...
                    <div className="md:flex w-full">
                        ...
                        <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                {success ? showSuccess('Bạn đã đăng ký thành công') : ''}
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        <label htmlFor="nameUser" className="text-xs font-semibold px-1">Name</label>
                                        <div className="flex">
                                            ...
                                            <input id="nameUser" onFocus={() => setError('')} type="text" {...register('name')} className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="name" />
                                        </div>
                                    </div>
                                </div>
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        <label htmlFor="emailUser" className="text-xs font-semibold px-1">Email</label>
                                        <div className="flex">
                                            <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-email-outline text-gray-400 text-lg" /></div>
                                            <input id="emailUser" onFocus={() => setError('')} type="email" {...register('email')} className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith@example.com" />
                                        </div>
                                    </div>
                                </div>
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-12">
                                        <label htmlFor="passwordUser" className="text-xs font-semibold px-1">Password</label>
                                        <div className="flex">
                                            ...
                                            <input id="passwordUser" onFocus={() => setError('')} type="password" {...register('password')} className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************" />
                                        </div>
                                    </div>
                                </div>
                                <div className="flex -mx-3">
